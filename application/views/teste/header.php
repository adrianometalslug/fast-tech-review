            ...
            <ul class="icon-nav">
                <li class='dropdown'>
                    ...
                    <ul class="dropdown-menu pull-right message-ul">
                        <li>
                            <a href="#">
                                <img src="<?= base_url('assets/flat-admin/img/demo/user-1.jpg') ?>" alt="">
                                <div class="details">
                        ...
                        <li>
                            <a href="#">
                                <img src="<?= base_url('assets/flat-admin/img/demo/user-2.jpg') ?>" alt="">
                                <div class="details">
                        ...
                        <li>
                            <a href="#">
                                <img src="<?= base_url('assets/flat-admin/img/demo/user-3.jpg') ?>" alt="">
                                <div class="details">
                ...
                <li class='dropdown language-select'>
                    <a href="#" class='dropdown-toggle' data-toggle="dropdown"><img src="<?= base_url('assets/flat-admin/img/demo/flags/us.gif') ?>" alt=""><span>US</span></a>
                    <ul class="dropdown-menu pull-right">
                        <li>
                            <a href="#"><img src="<?= base_url('assets/flat-admin/img/demo/flags/br.gif') ?>" alt=""><span>Brasil</span></a>
                        </li>
                        <li>
                            <a href="#"><img src="<?= base_url('assets/flat-admin/img/demo/flags/de.gif') ?>" alt=""><span>Deutschland</span></a>
                        </li>
                        <li>
                            <a href="#"><img src="<?= base_url('assets/flat-admin/img/demo/flags/es.gif') ?>" alt=""><span>España</span></a>
                        </li>
                        <li>
                            <a href="#"><img src="<?= base_url('assets/flat-admin/img/demo/flags/fr.gif') ?>" alt=""><span>France</span></a>
                        </li>
                    </ul>
                </li>
            </ul>
            <div class="dropdown">
                <a href="#" class='dropdown-toggle' data-toggle="dropdown">John Doe <img src="<?= base_url('assets/flat-admin/img/demo/user-avatar.jpg') ?>" alt=""></a>
                <ul class="dropdown-menu pull-right">
                    <li>
